  ...
  return (
    <div className="w-full bg-white shadow-lg dark:bg-gray-800 dark:border-gray-700 ">
        ...
        <div className="px-3 pb-3 pt-2 space-y-2 dark:bg-white dark:text-black">
            <a href="#" className="block text-xs font-semibold tracking-tight text-gray-900 dark:text-black capitalize">departamento cerca de</a>
            <section className='text-xs flex justify-between'>
                <span className="font-medium text-gray-900 dark:text-black">$ 4800.000</span>
