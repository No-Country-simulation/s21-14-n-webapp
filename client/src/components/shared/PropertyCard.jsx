...
const PropertyCard = ({ id, imgSrc, title, price, address }) => {
  ...
  return (
    <div className="w-full bg-white shadow-lg dark:bg-gray-800 dark:border-gray-700 cursor-pointer" onClick={handleClick}>
      ...
      <div className="px-3 pb-3 pt-2 space-y-2 dark:bg-white dark:text-black">
        <h2 className="block text-xs font-semibold tracking-tight text-gray-900 dark:text-black capitalize">
          {title}
        </h2>
