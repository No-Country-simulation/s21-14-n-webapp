        ...
        >
          <figure className="h-10 px-4 border-r flex justify-center items-center">
            <div className={`transition-transform duration-500 ease-in-out ${isOpen ? "rotate-180" : "rotate-0"}`}>
              <svg className="h-5 w-5 fill-current stroke-secundary stroke-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <h3 className='font-bold text-lg text-secundary '>{title}</h3>
        </div>
