...
export default function FeaturedProperties() {
    ...
    const featurePropeties = [
        '/img/feature-properties/pexels-30nudos-adicora-164429726-13907871.jpg',
        '/img/feature-properties/pexels-kate-filatova-1861817299-30707539.jpg',
        '/img/feature-properties/pexels-rgsk97-1717272.jpg',
        '/img/feature-properties/pexels-scottwebb-430216.jpg'
    ];
